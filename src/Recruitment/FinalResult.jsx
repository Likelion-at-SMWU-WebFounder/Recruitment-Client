    ...
    <Container>
      ...
      <BoxContainer>
        ...
        <BoxContainer>
            ...
            <AText href="https://docs.google.com/forms/d/e/1FAIpQLSe91tUYRMvMRiK3nAviXnNePDDpS3JhRfudOBphni011pwneg/viewform"
            target="_blank">
    ...
    <BoxContainer>
      ...
      <BoxContainer>
        ...
        <BoxContainer>
            ...
            <Text>안타깝지만 지원자님의 우수한 역량에도 불구하고, 면접 심사 과정에서 <ColorText color='#E67800'>{name}</ColorText>님께 합격 소식을 전해드리지 못하게 되었습니다.</Text>
            <Text>저희 멋쟁이사자처럼에 지원하신 모든 분들이 차후 더 좋은 기회를 맞이할 것이라고 생각하며, 아쉽지만 <ColorText color='#E67800'>{name}</ColorText>님의 면접 참석에 대해 다시 한번 감사드립니다.
            </Text>
        </BoxContainer>
        <BoxContainer>
            <Text>감사합니다.</Text>
