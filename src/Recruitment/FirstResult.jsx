...
const FirstResult = ({ name, message }) => {
    return (
        <Layout>
            <Container>
                ...
                <PassContainer message={message}>
                    <BoxContainer>
                        ...
                        <Text>2024 멋쟁이사자처럼 12기 서류 전형 "합격"을 진심으로 축하드립니다.</Text>
                        <Text>{name} 지원자님이 선택하셨던 면접 시간을 고려하여 아래의 일정으로 면접 전형을 진행할 예정입니다.</Text>
                        <Text>서류 접수 시 작성한 이메일로 서류 합격 메일도 발송되었습니다.</Text>
                    </BoxContainer>
                    <BoxContainer>
                        <Text>1. 면접 일시: 메일 확인 부탁드립니다. </Text>
                        <Text>2. 면접 장소: 본교 명신관 505호 (대면 면접)</Text>
                        <Text>3. 회신 사항: 면접 참석 여부를 금일 16시까지 반드시 메일로 회신 부탁드립니다.</Text>
                    </BoxContainer>
                    <BoxContainer>
                        <Text>*면접 시간 10분 전까지 대기실(명신관 603호)에 착석해 주시길 바랍니다.</Text>
                        <Text>*추가로 불가피한 사정으로 면접 시간 변경이 필요한 경우, 마찬가지로 메일 회신 부탁드립니다.</Text>
                    </BoxContainer>
                    <BoxContainer>
                ...
                <FailContainer message={message}>
                    ...
                    <BoxContainer>
                        ...
                        <Text>안타깝지만 지원자님의 우수한 역량에도 불구하고, 서류 심사 과정에서 합격 소식을 전해드리지 못하게 되었습니다.</Text>
                        <Text>아쉽지만 지원자님의 서류 지원에 대해 다시 한번 감사드리며, 저희 멋쟁이사자처럼에 지원하신 모든 분들이 차후 더 좋은 기회를 맞이할 것이라고 생각합니다.</Text>
                    </BoxContainer>
                    <BoxContainer>
                        <Text>감사합니다.</Text>
                    </BoxContainer>
