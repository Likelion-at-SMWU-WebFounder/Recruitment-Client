...
const Makers = () => {
  ...
  return (
    ...
    를 {768 <= window.innerWidth <= 480 && <br />} 만든 멋쟁이 개발자들입니다. <Hr /></Text>
        ...
        <ProfileContainer>
        <Img src="jiyoon.svg" alt="Profile" />
          <BoxContainer>
        ...
        <RowProfile>
        <ProfileContainer>
        <Img src="soyoon.svg" alt="Profile" />
          <BoxContainer>
