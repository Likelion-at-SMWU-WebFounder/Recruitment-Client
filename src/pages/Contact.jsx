...
const Contact = () => {
  ...
  return (
    ...
    <Text MobliefontSize="30px" fontSize="40px" marginBottom="20px" fontWeight="600">CONTACT</Text>
    <Text MoblieLineHeight="24px" MobliefontSize="16px" fontSize="20px" marginBottom="40px" fontWeight="200">운영 및 후원 관련 문의사항이 있으시다면, 하단 연락처로 문의주시기 바랍니다. </Text>
    ...
    <Text MobliefontSize="28px" fontSize="40px" marginBottom="20px" fontWeight="600">FAQ</Text>
    <Text MobliefontSize="17px" fontSize="20px" marginBottom="40px" fontWeight="200">자주 묻는 질문들을 확인해 보세요.</Text>
    <FAQList />
